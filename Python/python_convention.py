...
class ThisIsTheBestClass():
    """First line describes shortly what the class does.

    Paragraphs to describe in more detail if needed.

    Attributes
    ----------
    type : name : comment
    int : age : set age
    boolean : gender : True if female

    Methods
    -------
    method_name(parameter type) :
        return : type
    set_age(self, int) :
        return : None
    get_age(self) :
    ...
    def method_in_class(self):
        """First line describes shortly what the method does.
        ...
        int : age : set age
        boolean : gender : True if female
        return : int : age : (optional comment)
